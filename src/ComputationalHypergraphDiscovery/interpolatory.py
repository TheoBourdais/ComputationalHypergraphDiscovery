...
def perform_regression(K, ga, gamma, gamma_min, key):
    ...
    """
    return perform_interpolatory_regression_and_find_gamma(K=K, ga=ga, gamma_min=gamma_min, key=key)


def perform_interpolatory_regression_and_find_gamma(K, ga, gamma_min, key):
    """
